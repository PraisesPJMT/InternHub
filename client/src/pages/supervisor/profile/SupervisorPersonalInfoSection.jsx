...
const SupervisorPersonalInfoSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="p-5 border rounded-lg flex flex-col gap-5 relative">
        ...
        <ProfileImageForm
          editMode={editMode}
          profileImageLik={user?.profileImage}
        />
...
export default SupervisorPersonalInfoSection;

const ProfileImageForm = ({ editMode }) => {
  const { user } = useSelector((state) => state.authStore);
  ...
  return (
    <div className="w-full flex flex-col gap-3">
      <FieldLabel>{editMode ? "Change Avatar" : "Avatar"}</FieldLabel>
        ...
        <div className="flex items-center justify-center">
          ...
          >
            <div className="relative w-14 h-14 rounded-full bg-gray-300 overflow-hidden">
              ...
              {editMode && (
                <div className="absolute inset-0 bg-gray-300/20 text-gray-700 bg-opacity-50 flex items-center justify-center">
                  <Icon icon="iconamoon:edit-fill" width="24" height="24" />
                </div>
              )}
            </div>
