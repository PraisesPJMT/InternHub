import InternInternshipListWeek from "./InternsInternshipListWeek";

const InternInternshipDetails = () => {
  return (
    <section className="p-5 border space-y-4 rounded-lg">
      ...
      <InternInternshipListWeek />
    </section>
  );
};

export default InternInternshipDetails;
