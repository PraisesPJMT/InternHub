...
const fetchStudents = async ({ page, limit, sortBy, sortOrder, search }) => {
  ...
  // e.g., `/api/interns?page=${page}&limit=${limit}&sortBy=${sortBy}&sortOrder=${sortOrder}&search=${search}`
...
const SupervisorActiveInternsList = () => {
  // Table State
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => <div className="">{row.original.faculty}</div>,
      },
      {
            ...
            {isLoading ? (
              <TableRow>
                <TableCell colSpan={columns.length} className="p-0">
                  <LoadingState message="Loading interns..." />
                </TableCell>
              </TableRow>
            ) : isError ? (
              <TableRow>
                  ...
                  <EmptyState
                    ...
                    description={
                      search
                        ...
                        : "There are no interns to display at the moment."
                    }
                  />
                </TableCell>
              </TableRow>
...
export default SupervisorActiveInternsList;
