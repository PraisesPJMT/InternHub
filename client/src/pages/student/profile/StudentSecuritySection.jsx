...
const SignatureImageForm = ({ editMode }) => {
  ...
  */
  ...
  const uploadMutation = useMutation({
    mutationFn: async () => {
      ...
      const { data } = await api.post("/users/signature", formData);
      return data;
    },
  ...
  */
  ...
  const deleteMutation = useMutation({
    mutationFn: async () => {
      const { data } = await api.delete("/users/delete-signature");
      return data;
    },
    ...
    onSuccess: (data) => {
      ...
      toast.success(data.message || "Signature deleted");
    },
        ...
        {editMode && (
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              disabled={!user?.signature || deleteMutation.isPending}
